...
st.markdown("""
This tool allows you to query projects supported by NIHR infrastructure during 2022/23 and 2023/24 returns a summary generated by the Gemini AI model.
- Enter your **Google API Key** (Google 'Google AI Studio' to create your key).
- Enter your **query** (e.g., "cancer research").
- Optionally, specify what to **focus on** in the summary.
""")

# User Input: API Key, Query, and Focus
api_key = st.text_input("🔑 Enter your Google API Key:", type="password")
query = st.text_input("📝 Enter your query:")
focus_on = st.text_input("🎯 Focus on (optional):")
...
if api_key and query:
    try:
        ...
        embeddings_matrix = np.vstack(df['embeddings'].apply(eval).values)  # Ensure embeddings are parsed correctly
...
Ensure that you write in a neutral scientific tone, using precise language. Only talk about the evidence you are presented with in the prompt, but make the links between them whenever possible.
...
"""
    ...
    st.info("💡 Enter your API key and query to get started.")
